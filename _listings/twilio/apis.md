...
- name: Twilio GetParticipantForConference
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/conferences/master/_listings/twilio/accounts-accountsid-conferences-conferencesid-participants-callsid-format-get-postman.md
x-common:
- type: x-net-library
